...
def conv_kl_ae_v1_1():
    ...
    conv_ae = ConvKLAEV1(path_dataset=DS_5K,
                         name='conv_kl_ae_v1_1',
                         rho=rho,
                         beta=beta,
                         optimizer=optimizer)
...
def conv_kl_ae_v1_2():
    ...
    conv_ae = ConvKLAEV1(path_dataset=DS_25K,
                         name='conv_kl_ae_v1_2',
                         rho=rho,
                         beta=beta,
                         optimizer=optimizer)
